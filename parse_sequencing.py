...
file = r"c:\Users\Imart\Desktop\Multi Agent\Spec Sequencing Agent Final.json"

with open(r"c:\Users\Imart\Desktop\Multi Agent\sequencing_blueprint.md", "w", encoding="utf-8") as out:
    try:
