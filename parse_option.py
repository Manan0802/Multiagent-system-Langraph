...
file = r"c:\Users\Imart\Desktop\Multi Agent\Option Audit Agent v1.json"

with open(r"c:\Users\Imart\Desktop\Multi Agent\option_blueprint.md", "w", encoding="utf-8") as out:
    try:
